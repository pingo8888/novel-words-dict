...
pub(crate) use editor::{
    ...
    set_editor_window_title, take_editor_seed,
};
pub(crate) use entries::{
    delete_entry, get_bundled_entry, get_bundled_entry_dict_name, get_entry, list_dictionaries,
    query_entries, upsert_entry,
};
